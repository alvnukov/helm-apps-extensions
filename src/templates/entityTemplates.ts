...
export function renderEntityTemplateLines(groupType: string, appName: string): string[] {
  switch (groupType as EntityTemplateGroupType) {
    ...
    case "apps-configmaps":
      return withAppRoot(appName, [
        "    enabled: true",
        "    # Non-sensitive runtime config (text + optional binary attachments)",
        ...
        "        _default: info",
        "        prod: warn",
        "    # Optional: pass native top-level ConfigMap fields when needed",
        "    extraFields:",
        "      immutable: false",
      ]);
    ...
    case "apps-secrets":
      return withAppRoot(appName, [
        ...
        "    type: Opaque",
        "    # Values here are plain; renderer encodes them to base64 into Secret.data",
        "    data:",
        "      DB_USER: app",
        "      DB_PASSWORD:",
        ...
        "        _default: token-dev",
        "        prod: token-prod",
        "    # Optional: add native Secret fields (`stringData`, `binaryData`, `immutable`)",
        "    extraFields:",
        "      immutable: false",
      ]);
    ...
    case "apps-k8s-manifests":
      return withAppRoot(appName, [
        ...
        "      FEATURE_X: \"true\"",
        "    immutable: false",
        "    # For Secret kinds you can also use `type`, `stringData`, `binaryData`",
        "    extraFields:",
        "      ownerReferences: |-",
        "        - apiVersion: apps/v1",
        "          kind: Deployment",
